...
from SecretMusic.utils import SecretBin, get_channeplayCB, seconds_to_min
from SecretMusic.utils.database import get_cmode, is_active_chat, is_music_playing
from SecretMusic.utils.decorators.language import language, languageCB
from SecretMusic.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://raw.githubusercontent.com/Secretaidev/SecretMusic/main/SecretMusic/assets/SecretAI.png",
        caption=_["queue_1"],
    )
