...
from SecretMusic.utils.database import db

try:
    wlcm = db.welcome
except:
    from SecretMusic.utils.database import welcome as wlcm
...
def welcomepic(pic, user, chat, id, uname):
    background = Image.open("SecretMusic/assets/welcome.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((450, 450)) 
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('SecretMusic/assets/font.ttf', size=45)
    font2 = ImageFont.truetype('SecretMusic/assets/font.ttf', size=90)
...
async def greet_group(_, member: ChatMemberUpdated):
    ...
    try:
        ...
        pic = "SecretMusic/assets/upic.png"
