...
import config
from SecretMusic import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from SecretMusic.core.call import SecretCall
from SecretMusic.utils import seconds_to_min, time_to_seconds
from SecretMusic.utils.channelplay import get_channeplayCB
from SecretMusic.utils.decorators.language import languageCB
from SecretMusic.utils.decorators.play import PlayWrapper
from SecretMusic.utils.formatters import formats
from SecretMusic.utils.inline import (
    botplaylist_markup,
    livestream_markup,
    playlist_markup,
    slider_markup,
...
from SecretMusic.utils.logger import play_logs
from SecretMusic.utils.stream.stream import stream
...
async def play_commnd(
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                await SecretCall.stream_call(url)
...
@app.on_callback_query(filters.regex("SecretPlaylists") & ~BANNED_USERS)
@languageCB
