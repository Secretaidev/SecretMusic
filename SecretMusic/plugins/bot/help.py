...
from SecretMusic.utils.database import get_lang
from SecretMusic.utils.decorators.language import LanguageStart, languageCB
from SecretMusic.utils.inline.help import (
    help_back_markup,
    private_help_panel,
    help_pannel_page1,
    help_pannel_page2,
...
async def helper_private(
    ...
    if is_callback:
        ...
        from SecretMusic.utils.inline.help import help_pannel_page1
...
async def help_com_group(client, message: Message, _):
    from SecretMusic.utils.inline.help import private_help_panel
...
async def helper_cb(client, CallbackQuery, _):
    ...
    def get_keyboard_for(cb):
        ...
        page4 = ["hb32", "hb33", "hb34", "hb35", "hb36", "hb37", "hb38", "hb39", "hb40", "hb41"]
    ...
    if cb == "hb1":
        ...
        await CallbackQuery.edit_message_text(helpers.HELP_41, reply_markup=get_keyboard_for(cb))
